...
/**
 * The concrete implementation of the Disjucntion variant, for ReBAC policy formula
 */
public class DisjunctionImpl extends PolicyImpl implements Disjunction {
	 ...
	 */
	public DisjunctionImpl(PolicyImpl policyA, PolicyImpl policyB) {
	...
	public PolicyImpl copy() {
		...
		return new DisjunctionImpl(tempA, tempB);
	}
