...
/**
 * The concrete implementation of the Box variant, for ReBAC policy formula
 */
public class BoxImpl extends PolicyImpl implements Box {
	 ...
	 */
	public BoxImpl(PolicyImpl policy, String implicitRelId, Direction direction) {
		this.policy = policy;
	 ...
	 * @param direction The indicator for the direction of relationship.
	 */
	public BoxImpl(PolicyImpl policy, AccessRelationshipType explicitRelId, Direction direction) {
		this.policy = policy;
	 ...
	 * @param direction The indicator for the direction of relationship.
	 */
	public BoxImpl(PolicyImpl policy, RelationshipType patientRecordRelId, Direction direction) {
		this.policy = policy;
	...
	public PolicyImpl copy() {
		...
		if (implicitRelId != null) {
			return new BoxImpl(temp, new String(implicitRelId), getDirection());
		} else if (explicitRelId != null) {
			return new BoxImpl(temp, explicitRelId, getDirection());
		} else {
			return new BoxImpl(temp, patientRecordRelId, getDirection());
		}
	}
