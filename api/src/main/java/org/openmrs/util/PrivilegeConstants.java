...
public class PrivilegeConstants {
	...
	@AddOnStartup(description = "Able to get Authorization Principals")
	public static final String GET_AUTHORIZATION_PRINCIPALS = "Get Authorization Principals";
	
	@AddOnStartup(description = "Able to add/edit Authorization Principals")
	public static final String MANAGE_AUTHORIZATION_PRINCIPALS = "Manage Authorization Princiapls";
	
	@AddOnStartup(description = "Able to get Rebac Policy Factories")
	public static final String GET_REBAC_POLICY_FACTORIES = "Get Rebac Policy Factories";
	
	@AddOnStartup(description = "Able to add/edit Rebac Policy Factories")
	public static final String MANAGE_REBAC_POLICY_FACTORIES = "Manage Rebac Policy Factories";
	
	@AddOnStartup(description = "Able to add/edit/delete Privilege Assignments")
	public static final String MANAGE_PRIVILEGE_ASSIGNMENTS = "Manage Privilege Assignments";
	
	@AddOnStartup(description = "Able to toggle ReBAC authorization on/off")
	public static final String MANAGE_REBAC_AUTHORIZATION_TOGGLE = "Manage Rebac Authorization Toggle";
	
	@AddOnStartup(description = "Able to add/edit/delete Actions")
	public static final String MANAGE_ACTIONS = "Manage Actions";
	
	@AddOnStartup(description = " Add to add/delete Hybrid Formulas")
	public static final String MANAGE_HYBRID_FORMULAS = "Manage Hybrid Formulas";
}
