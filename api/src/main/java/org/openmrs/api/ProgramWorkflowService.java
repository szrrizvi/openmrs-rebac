...
public interface ProgramWorkflowService extends OpenmrsService {
	...
	public PatientProgram savePatientProgram(@Resource PatientProgram patientProgram) throws APIException;
	...
	public void purgePatientProgram(@Resource PatientProgram patientProgram) throws APIException;
	 ...
	 */
	@Authorized( { PrivilegeConstants.PURGE_PATIENT_PROGRAMS })
	public void purgePatientProgram(@Resource PatientProgram patientProgram, boolean cascade) throws APIException;
	...
	public PatientProgram voidPatientProgram(@Resource PatientProgram patientProgram, String reason) throws APIException;
	 ...
	 */
	@Authorized( { PrivilegeConstants.DELETE_PATIENT_PROGRAMS })
	public PatientProgram unvoidPatientProgram(@Resource PatientProgram patientProgram) throws APIException;
	...
	public void updatePatientProgram(@Resource PatientProgram patientProgram) throws APIException;
	 ...
	 */
	@Authorized( { PrivilegeConstants.ADD_PATIENT_PROGRAMS })
	public void enrollPatientInProgram(@Resource Patient patient, Program program, Date enrollmentDate, Date completionDate,
	 ...
	 */
	@Authorized( { PrivilegeConstants.ADD_PATIENT_PROGRAMS, PrivilegeConstants.EDIT_PATIENT_PROGRAMS })
	public void changeToState(@Resource PatientProgram patientProgram, ProgramWorkflow workflow, ProgramWorkflowState state,
	 ...
	 */
	@Authorized( { PrivilegeConstants.ADD_PATIENT_PROGRAMS, PrivilegeConstants.EDIT_PATIENT_PROGRAMS })
	public void terminatePatientProgram(@Resource PatientProgram patientProgram, ProgramWorkflowState finalState,
	        Date terminatedOn);
	 ...
	 */
	@Authorized( { PrivilegeConstants.EDIT_PATIENT_PROGRAMS })
	public void voidLastState(@Resource PatientProgram patientProgram, ProgramWorkflow wf, String voidReason)
	        throws APIException;
