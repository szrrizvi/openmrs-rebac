...
public class ServiceContext implements ApplicationContextAware {
	...
	/**
	 * Gets the AccessRelationshipService used in the context
	 * 
	 * @return AccessRelationshipService
	 */
	public AccessRelationshipService getAccessRelationshipService() {
		return getService(AccessRelationshipService.class);
	}
	
	/**
	 * Sets the AccessRelationService used in the context
	 * 
	 * @param accessRelationshipService the AccessRelationshipService to use
	 */
	public void setAccessRelationshipService(AccessRelationshipService accessRelationshipService) {
		setService(AccessRelationshipService.class, accessRelationshipService);
	}
	
	/**
	 * Gets the AuthorizationPrincipalService used in the context
	 * 
	 * @return AuthorizationPrincipalService
	 */
	public AuthorizationPrincipalService getAuthorizationPrincipalService() {
		return getService(AuthorizationPrincipalService.class);
	}
	
	/**
	 * Sets the AuthorizationPrincipalService used in the context
	 * 
	 * @param authorizationPrincipalService the AuthorizationPrincipalService to use
	 */
	public void setAuthorizationPrincipalService(AuthorizationPrincipalService authorizationPrincipalService) {
		setService(AuthorizationPrincipalService.class, authorizationPrincipalService);
	}
	
	/**
	 * Gets the ActionService used in the context
	 * 
	 * @return ActionService
	 */
	public ActionService getActionService() {
		return getService(ActionService.class);
	}
	
	/**
	 * Sets the ActionService used in the context
	 * 
	 * @param actionService The ActionService to use
	 */
	public void setActionService(ActionService actionService) {
		setService(ActionService.class, actionService);
	}
	
	/**
	 * Gets the ActionExecutionService used in the context
	 * 
	 * @return ActionExecutionService
	 */
	public ActionExecutionService getActionExecutionService() {
		return getService(ActionExecutionService.class);
	}
	
	/**
	 * Sets the ActionExecutionService used in the context
	 * 
	 * @param actionService The ActionExecutionService to use
	 */
	public void setActionExecutionService(ActionExecutionService actionExecutionService) {
		setService(ActionExecutionService.class, actionExecutionService);
	}
