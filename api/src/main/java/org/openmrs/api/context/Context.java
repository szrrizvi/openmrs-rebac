...
public class Context {
	...
	/**
	 * @see ServiceContext#getAccessRelationshipService()
	 */
	public static AccessRelationshipService getAccessRelationshipService() {
		return getServiceContext().getAccessRelationshipService();
	}
	
	/**
	 * @see ServiceContext#getAuthorizationPrincipalService()
	 */
	public static AuthorizationPrincipalService getAuthorizationPrincipalService() {
		return getServiceContext().getAuthorizationPrincipalService();
	}
	
	/**
	 * @see ServiceContext#getActionService()
	 */
	public static ActionService getActionService() {
		return getServiceContext().getActionService();
	}
	
	/**
	 * @see ServiceContext#getActionExecutionService()
	 */
	public static ActionExecutionService getActionExecutionService() {
		return getServiceContext().getActionExecutionService();
	}
