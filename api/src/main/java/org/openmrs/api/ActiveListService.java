...
public interface ActiveListService extends OpenmrsService {
	 ...
	 * @throws APIException
	 */
	public ActiveListItem saveActiveListItem(@Resource ActiveListItem item) throws APIException;
	 ...
	 * @throws APIException
	 */
	public ActiveListItem removeActiveListItem(@Resource ActiveListItem item, Date endDate) throws APIException;
	 ...
	 * @throws APIException
	 */
	public ActiveListItem voidActiveListItem(@Resource ActiveListItem item, String reason) throws APIException;
}
