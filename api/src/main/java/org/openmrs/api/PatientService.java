...
public interface PatientService extends OpenmrsService {
	...
	public Patient savePatient(@Resource Patient patient) throws APIException;
	...
	public Patient voidPatient(@Resource Patient patient, String reason) throws APIException;
	 ...
	 */
	@Authorized( { PrivilegeConstants.DELETE_PATIENTS })
	public Patient unvoidPatient(@Resource Patient patient) throws APIException;
	...
	public void deletePatient(@Resource Patient patient) throws APIException;
	 ...
	 */
	@Authorized( { PrivilegeConstants.PURGE_PATIENTS })
	public void purgePatient(@Resource Patient patient) throws APIException;
	...
	public void updatePatientIdentifier(@Resource PatientIdentifier patientIdentifier) throws APIException;
	...
	public PatientIdentifierType savePatientIdentifierType(@Resource PatientIdentifierType patientIdentifierType)
	        throws APIException;
	...
	public void mergePatients(@Resource Patient preferred, Patient notPreferred) throws APIException, SerializationException;
	 ...
	 */
	public void mergePatients(@Resource Patient preferred, List<Patient> notPreferred) throws APIException,
	 ...
	 */
	@Authorized( { PrivilegeConstants.EDIT_PATIENTS })
	public void exitFromCare(@Resource Patient patient, Date dateExited, Concept reasonForExit) throws APIException;
	 ...
	 */
	@Authorized( { PrivilegeConstants.EDIT_PATIENTS })
	public void processDeath(@Resource Patient patient, Date dateDied, Concept causeOfDeath, String otherReason)
	        throws APIException;
	...
	public void saveCauseOfDeathObs(@Resource Patient patient, Date dateDied, Concept causeOfDeath, String otherReason)
	        throws APIException;
	...
	public void saveProblem(@Resource Problem problem) throws APIException;
	...
	public void removeProblem(@Resource Problem problem, String reason) throws APIException;
	...
	public void voidProblem(@Resource Problem problem, String reason) throws APIException;
	...
	public void saveAllergy(@Resource Allergy allergy) throws APIException;
	...
	public void removeAllergy(@Resource Allergy allergy, String reason) throws APIException;
	...
	public void voidAllergy(@Resource Allergy allergy, String reason) throws APIException;
