...
public class ApplicationPrivilegeConstants {
	...
	@AddOnStartup(description = "Able to view the 'Actions Section' tab on the patient dashboard")
	public static final String DASHBOARD_ACTIONS = "Patient Dashboard - View Actions Section";
}
