...
<div id="patientTabs" class="${patientVariation}">
	<ul>
		...
		<openmrs:hasPrivilege privilege="Patient Dashboard - View Graphs Section">
			<li><a id="actionsExecuteTab" href="#" onclick="return changeTab(this);" hidefocus="hidefocus"><openmrs:message code="patientDashboard.actions"/></a></li>
		</openmrs:hasPrivilege>
...
<div id="patientSections">
	...
	<openmrs:hasPrivilege privilege="Patient Dashboard - View Actions Section">
		<div id="actionsExecute" style="display:none;">
		
			<openmrs:extensionPoint pointId="org.openmrs.patientDashboard.ActionsTabHeader" type="html" parameters="patientId=${patient.patientId}" />
			<openmrs:portlet url="actionsExecute" id="actionsExecutePortlet" patientId="${patient.patientId}"/>
