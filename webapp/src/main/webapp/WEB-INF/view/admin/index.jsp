...
<table border="0" width="93%">
	...
	<tr>
		...
		<td valign="top" width="30%">
			...
			<openmrs:hasPrivilege privilege="Manage Relationships,Manage Authorization Principal,Manage Actions">
				<div class="adminMenuList">
					<h4><openmrs:message code="Rebac.header"/></h4>
						<%@ include file="rebac/localHeader.jsp" %>
				</div>
			</openmrs:hasPrivilege>
